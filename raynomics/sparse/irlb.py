# This code is from https://github.com/bwlewis/irlbpy
...
# This is the Ray version of irlb
def irlb(A,n,num_workers,tol=0.0001,maxit=50):
  ...
  A_ids = raynomics.sparse.mvp.partition_matrix_rows(A, num_workers)
  At = A.transpose().tocsr()
  At_ids = raynomics.sparse.mvp.partition_matrix_rows(At, num_workers)
...
def origirlb(A,n,tol=0.0001,maxit=50):
  """Estimate a few of the largest singular values and corresponding singular
  vectors of matrix using the implicitly restarted Lanczos bidiagonalization
  method of Baglama and Reichel, see:
  Augmented Implicitly Restarted Lanczos Bidiagonalization Methods,
